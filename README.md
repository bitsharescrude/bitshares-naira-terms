...
XBITS reserves the right to modify or change the Terms at any time and at its sole discretion. XBITS will provide notice of these changes by updating the revised Terms on the webpage (https://github.com/noblenobert/bitshares-naira-terms/) and changing the “[Last revised:]” date on this page. Any and all modifications or changes to these Terms will be effective immediately upon being announced on the website. As such, your continued use of XBITS services acts as acceptance of the amended agreement and rules. If you do not agree to any modification to these Terms, you must stop using the Services. XBITS encourages you to frequently review the Terms to ensure you understand the terms and conditions that apply to your access to, and use of, the Services.
